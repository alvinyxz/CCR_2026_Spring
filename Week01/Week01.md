- [1. R](#1-r)
  - [1.1. R - Basic Setup](#11-r---basic-setup)
  - [1.2. R - Basic Commands 1](#12-r---basic-commands-1)
  - [1.3. R - Basic Commands 2](#13-r---basic-commands-2)
  - [1.4. R - Common Commands](#14-r---common-commands)
- [2. Python](#2-python)
  - [2.1. Python - Google Colab](#21-python---google-colab)
  - [2.2. Python - IDE](#22-python---ide)
  - [2.3. Python - Basic Commands 1](#23-python---basic-commands-1)
  - [2.4. Python - Basic Commands 2](#24-python---basic-commands-2)
  - [2.5. Python - Common Commands](#25-python---common-commands)
- [3. Learn how to debug your code with ChatGPT](#3-learn-how-to-debug-your-code-with-chatgpt)
- [4. Focus on R and One More Add-On](#4-focus-on-r-and-one-more-add-on)
...
The model code scripts are stored in this folder as well. However, I do not recommend you to use it. Instead, follow the steps below and create your own files. The model code scripts are just there when you encounter serious problems.
...
2. Open `praise.R` again, make sure .R is associated with RStudio from now on. Run the code again to get a new random praise message.

### 1.2. R - Basic Commands 1
...
3. Save the file as `basic_commands_1.R` locally.
2. Run the code by selecting it and pressing "Ctrl + Enter" or clicking the "Run" button in RStudio.
3. You should see the output `15` in the console.

### 1.3. R - Basic Commands 2
...
5. View the first few rows of the dataset. Remember, while you can type it in the console to run it, I recommend you to always type this in the script file, so that you can save it again later.
...
2. We also need to know what class the object is. You can do that by:

```r
class(mtcars) # The `mtcars` dataset is a data frame, which is a table-like structure in R.
class(mtcars$mpg) # While the `mpg` column is numeric, which means it contains numbers.
```

8. You can also check the structure of the dataset using the following code. This will give you information about the columns, their types, and the first few values in each column.

```r
str(mtcars)
```

9. This is important because we need to know what kind of data we are dealing with. For example, if you want to do a regression analysis, you need to know if the variables are numeric or categorical. Sometimes, the class of the variable is not what you expect. For example, if you have a number variable, but it could be wrongfully stored as a character string:
...
10. Instead, you should use "as." commands to change it to the class that you need:
...
11. Further, you can type out these commands to visually learn the differences:
...
12. Save the file as `basic_commands_2.R` locally.
2. For more information on data structures in R, see Jo's tutorial: <https://jolukito.quarto.pub/j381m-textbook/05-structures.html>

### 1.4. R - Common Commands
...
# You can set it to your own path, like "C:/Users/YourName/Documents/" or on your desktop
# Reading in a CSV file
my_data <- read.csv("C:/Users/YourName/Documents/Week01.csv")
# But if you have already set the working directory and the file is in that directory, you can just do:
my_data <- read.csv("Week01.csv")
...
3. Some very common keyboard shortcuts in RStudio:
   ...
   - Ctrl + Shift + M: Insert the pipe operator (%>%) (ignore for now, but we might talk about later)
2. One common keyboard shortcut to copy a file's path:
   - On Mac: Command + Option + C
   - On Windows: Hold down Shift, then right-click the file

## 2. Python

There are two ways to run Python code: through an IDE (Integrated Development Environment) (like RStudio) or, more easily nowadays, through Google Colab.

### 2.1. Python - Google Colab

1. Go to <https://colab.research.google.com/>
2. Click on "New Notebook" in the bottom right corner
3. It will open a new tab with a blank notebook
...
5. Run the cell by clicking the “Run” button or pressing Shift + Enter
2. Since you are using Google Colab, you can also use Markdown (a text-based formatting syntax) to write notes. To do this, **create a new cell** and change the cell type from Code to Text from the dropdown menu. Type:
...
7. Run the cell to see the formatted text
2. Since Python doesn't have an equivalent of R's `praise` package, we will use the `random` package to generate a random praise. Type:
...
9. Run the cell by clicking the “Run” button or pressing Shift + Enter

### 2.2. Python - IDE

If you prefer locally-run code, we can use the Anaconda distribution of Python. It includes Python, JupyterLab, and many essential libraries for data science and computational social science.
...
2. Since you are using JupyterLab, you can also use Markdown (a text-based formatting syntax) to write notes. To do this, **create a new cell** and change the cell type from Code to Markdown from the dropdown menu. Type:
...
### 2.3. Python - Basic Commands 1

1. Regardless of whether you are using Google Colab or JupyterLab, create a new notebook and name it `basic_commands_1.ipynb`
...
### 2.4. Python - Basic Commands 2

1. Regardless of whether you are using Google Colab or JupyterLab, create a new notebook and name it `basic_commands_2.ipynb`
...
### 2.5. Python - Common Commands

1. Regardless of whether you are using Google Colab or JupyterLab, create a new notebook and name it `common_commands.ipynb`
...
## 3. Learn how to debug your code with ChatGPT
...
2. Run them in RStudio and JupyterLab
...
8. You can also use ChatGPT to explain the code to you, so that you can understand it better.

## 4. Focus on R and One More Add-On
