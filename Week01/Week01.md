- [1. Week01](#1-week01)
  ...
  - [1.2. Python](#12-python)
    ...
    - [1.2.4. Python - Basic Commands 2](#124-python---basic-commands-2)
    - [1.2.5. Python - Common Commands](#125-python---common-commands)
...
13. For more information on data structures in R, see Jo's tutorial: https://jolukito.quarto.pub/j381m-textbook/05-structures.html

### 1.1.4. R - Common Commands
...
4. One common keyboard shortcut to copy a file's path:
...
6. Since you are using Google Colab, you can also use Markdown (a text-based formatting syntax) to write notes. To do this, **create a new cell** and change the cell type from Code to Text from the dropdown menu. Type:
```markdown
# This is a header
## This is a subheader
```
7. Run the cell to see the formatted text
8. Since Python doesn't have an equivalent of R's `praise` package, we will use the `random` package to generate a random praise. Type:
```python
import random
compliments = [
...
## 1.3. Learn how to debug your code with ChatGPT
...
## 1.4. Focus on R and One More Add-On
