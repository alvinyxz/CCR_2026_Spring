...
- [2. Course Schedule](#2-course-schedule)
  ...
  - [2.4. 2026/02/12 Text as Data: Overview and Dictionaries](#24-20260212-text-as-data-overview-and-dictionaries)
  - [2.5. 2026/02/19 Text as Data: Unsupervised Learning](#25-20260219-text-as-data-unsupervised-learning)
  - [2.6. 2026/02/26 Text as Data: Supervised Learning and Word Embeddings](#26-20260226-text-as-data-supervised-learning-and-word-embeddings)
  ...
  - [2.10. 2026/04/02 Data Visualization: Overview and Practices](#210-20260402-data-visualization-overview-and-practices)
  - [2.11. 2026/04/09 Data Visualization: Packaging and Presentation](#211-20260409-data-visualization-packaging-and-presentation)
...
There are three types of readings for each week: (1) Required Instructional Readings, (2) Required Empirical Readings, and (3) Optional Readings. Required Instructional Readings are textbook-like instructional materials that introduce computational methods and analytical techniques. Required Empirical Readings are research articles that apply computational methods to address important communication/media-related research questions. I keep Required Instructional Readings and Required Empirical Readings at a manageable level so that you can finish them before class. Optional readings are a collection of articles related to the week’s topic that you may find interesting; you are not required to read them.

In general, before class, you should have read both Required Instructional Readings and Required Empirical Readings, and carefully thought about: (1) how the computational methods used in each study helped address the specific research questions of interest to the authors, (2) in what sense these computational methods could extend conventional methods, (3) what are their major assumptions and limitations, and (4) what new arenas for future research these computational methods could open.
...
Throughout this semester, you are required to sign up for FOUR research papers on the Required Empirical Readings list. [Sign Up Here](https://z.umn.edu/J8500_SignUp). Each empirical reading should have exactly one student taking it, so go grab your preferred readings. For each reading, you will: (1) prepare a response letter with annotations (RLA), and (2) serve as the lead discussant for those assigned articles.
...
Throughout this semester, each student will sign up to demonstrate the functionalities and workflow of THREE R packages or computational tools. [Sign Up Here](https://z.umn.edu/J8500_SignUp) The list of candidate packages and their dates can be found in the Course Schedule, but they are simply recommended packages. If you find other packages that you think are relevant to the class, please discuss with me and we can change them. When you start preparing the demo, you are encouraged to meet me on Zoom and discuss your plan, as I may have specific expectations on what aspects of the package/tool I want you to demonstrate in class.

At maximum, THREE students can sign up for the same package and work as a group to collaboratively prepare and deliver the demo. You are welcome, and in fact *encouraged*, to "steal" existing tutorials and datasets available online. When there are multiple packages scheduled on the same day, groups responsible for those packages should coordinate with each other to ensure a coherent presentation without too much overlap.
...
The goal of the final paper is to contribute, no matter how modestly, to the burgeoning literature on computational communication science. The paper must apply one or more computational methods covered in this class (e.g., topic modeling, sentiment analyses, network analyses, neural network models, word embedding, computer vision, regularized regression, causal heterogeneity analyses) to propose, test and advance communication theory or to address a practical communication/media-related issue of significance. You are allowed to extend work developed in previous classes or research groups, but you should state so in your paper clearly and explain what new contributions your current work makes beyond prior work.

You have three options for the final research paper:

1. [Group Option] A complete research paper written collectively as a small group (maximum 3 students per group)
...
2. [Individual Option 1] An individual research proposal
    ...
    You are also welcome to use the final paper as an opportunity to design a new study that involves computational methods. You do not need to report results from data analyses or discuss your findings in a research proposal. No collaboration is allowed for this option. The originality of your paper, its implications for communication theory and practice, and the appropriateness of the proposed computational method(s) will be the key criteria for evaluation.

3. [Individual Option 2] A complete individual research paper
...
5. Overall Course Readings
   ...
   - Lazer, D., Pentland, A., Watts, D. J., Aral, S., Contractor, N., Freelon, D., Gonzalez-Bailon, S., King, G., Nelson, A., Salganik, J., Strohmaier, M., Vespignani, A., & Wagner, C. (2020). Computational social science: Obstacles and opportunities. *Science, 369*(6507), 1060–1062. <https://doi.org/10.1126/science.aaz8170>
     - Critique and Response: Wu, A. X., Taneja, H., boyd,  danah, Donato, P., Hindman, M., Napoli, P., & Webster, J. (2020). Computational social science: On measurement. *Science, 370*(6521), 1174.2-1175. <https://doi.org/10.1126/science.abe8308>
...
2. Required Empirical Readings
   ...
   - Chen, A., Chen, K., Zhang, J., Meng, J., & Shen, C. (2022). When national identity meets conspiracies: The contagion of national identity language in public engagement and discourse about COVID-19 conspiracy theories. *Journal of Computer-Mediated Communication, 28*(1), zmac034. <https://doi.org/10.1093/jcmc/zmac034>
...
5. Optional Readings
   ...
   - Stuhler, O., Tavory, I., & Wagner-Pacifici, R. (2026). Time and climate change: U.S. media representations of climate actions, horizons, and events (2000 to 2021). *American Sociological Review*, 00031224251403596. <https://doi.org/10.1177/00031224251403596>
   ...
   - Or its book version: Grimmer, J., Roberts, M. E., & Stewart, B. M. (2022). *Text as data: A new framework for machine learning and the social sciences*. Princeton University Press.
   ...
   - Lee, J., & Cho, M.-J. (2025). Online job scams: Unveiling the impact of overconfidence, digital literacy, and algorithmic literacy on user susceptibility to false job advertisements. *New Media & Society*, 14614448251377994. <https://doi.org/10.1177/14614448251377994>
...
## 2.6. 2026/02/26 Text as Data: Supervised Learning and Word Embeddings
...
2. Required Empirical Readings
   ...
   - Gong, X., Huskey, R., Xue, H., Shen, C., & Frey, S. (2023). Broadcast information diffusion processes on social media networks: Exogenous events lead to more integrated public discourse. *Journal of Communication, 73*(3), 247–259. <https://doi.org/10.1093/joc/jqad014>
...
4. Optional Readings
   ...
   - Shen, C., Monge, P., & Williams, D. (2014). Virtual brokerage and closure: Network structure and social capital in a massively multiplayer online game. *Communication Research, 41*(4), 459–480. <https://doi.org/10.1177/0093650212455197>
...
4. Optional Readings
   ...
   - Chuang, Y.-S., Goyal, A., Harlalka, N., Suresh, S., Hawkins, R., Yang, S., Shah, D., Hu, J., & Rogers, T. (2024). Simulating opinion dynamics with networks of LLM-based agents. *Findings of the Association for Computational Linguistics: NAACL 2024*, 3326–3346. <https://doi.org/10.18653/v1/2024.findings-naacl.211>
...
2. Required Empirical Readings
   - "The Meta 2020 Project" Press Release: *New Facebook and Instagram Research Initiative to Look at US 2020 Presidential Election*. <https://about.fb.com/news/2020/08/research-impact-of-facebook-and-instagram-on-us-election/>
   - "The Meta 2020 Project" Commentary: Wagner, M. W. (2023). Independence by permission. *Science, 381*(6656), 388–391. <https://doi.org/10.1126/science.adi2430>
   - "The Meta 2020 Project" González-Bailón, S., Lazer, D., Barberá, P., Zhang, M., Allcott, H., Brown, T., Crespo-Tenorio, A., Freelon, D., Gentzkow, M., Guess, A. M., Iyengar, S., Kim, Y. M., Malhotra, N., Moehler, D., Nyhan, B., Pan, J., Rivera, C. V., Settle, J., Thorson, E., … Tucker, J. A. (2023). Asymmetric ideological segregation in exposure to political news on Facebook. *Science, 381*(6656), 392–398. <https://doi.org/10.1126/science.ade7138>
   - "The Meta 2020 Project" Guess, A. M., Malhotra, N., Pan, J., Barberá, P., Allcott, H., Brown, T., Crespo-Tenorio, A., Dimmery, D., Freelon, D., Gentzkow, M., González-Bailón, S., Kennedy, E., Kim, Y. M., Lazer, D., Moehler, D., Nyhan, B., Rivera, C. V., Settle, J., Thomas, D. R., … Tucker, J. A. (2023). Reshares on social media amplify political news but do not detectably affect beliefs or opinions. *Science, 381*(6656), 404–408. <https://doi.org/10.1126/science.add8424>
...
4. Optional Readings
   - Commentary on González-Bailón et al. (2023)
